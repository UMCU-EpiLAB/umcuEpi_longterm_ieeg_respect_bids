...
elecdesc_json.pp                   = 'An electrode located on the primary propagation channels';
elecdesc_json.pr                   = 'An electrode located on the proposed resection';
elecdesc_json.edge                  = 'An electrode located on the edge of the resected area. It is unclear whether it is resected or not.';
elecdesc_json.screw                 = 'An electrode located in a screw. This is visualized on MRI and only applicable in seeg electrodes.';
elecdesc_json.csf                   = 'An electrode located in cerebrospinal fluid. This is visualized on MRI and only applicable in seeg electrodes.';
elecdesc_json.whitematter           = 'An electrode located in white matter tissue. This is visualized on MRI and only applicable in seeg electrodes.';
elecdesc_json.graymatter            = 'An electrode located in gray matter tissue. This is visualized on MRI and only applicable in seeg electrodes.';
elecdesc_json.hippocampus           = 'An electrode located in the hippocampus. This is visualized on MRI and only applicable in seeg electrodes.';
elecdesc_json.amygdala              = 'An electrode located in the amygdala. This is visualized on MRI and only applicable in seeg electrodes.';
elecdesc_json.lesion                = 'An electrode located in the lesion. This is visualized on MRI and only applicable in seeg electrodes.';
elecdesc_json.gliosis               = 'An electrode located in gliosis due to previous surgery. This is visualized on MRI and only applicable in seeg electrodes.';
