...
% idx_depths = logical(metadata.idx_depths);
% idx_strips = logical(idx_strips);

ch2use_included = metadata.ch2use_included;
idx_seeg = metadata.idx_seeg;
idx_depths = metadata.idx_depth;
idx_strips = metadata.idx_strip;
idx_grid = metadata.idx_grid;
