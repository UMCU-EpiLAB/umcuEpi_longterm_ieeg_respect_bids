...
partdesc_json.gender.Description               = 'gender of the patient (male/female/unknown)';
partdesc_json.gender.Levels.male               = 'male';
partdesc_json.gender.Levels.female             = 'female';
partdesc_json.gender.Levels.unknown            = 'unknown';
