...
edesc_json.sub_type                             = 'more description of event (sleep:nrem/rem, motor:Mario/hand/jump, sens:circle, electrical stimulation:SPES/ESM/REC2stim, seizure:clinical/subclinical)' ;
...
edesc_json.electrical_stimulation_frequency     = 'electrical stimulation frequency in Hertz';
edesc_json.electrical_stimulation_pulsewidth    = 'electrical stimulation pulse width in s';
